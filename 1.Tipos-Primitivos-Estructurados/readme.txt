...
En el programa, se definen ejemplos de cada tipo de dato utilizando las sintaxis correspondientes de Python. Por ejemplo, se asigna un valor entero a la variable `entero`, un valor real a la variable `real`, y así sucesivamente. Luego, se muestra cada ejemplo en la consola utilizando la función `print()`.

Esta práctica ayuda a comprender los diferentes tipos de datos disponibles en Python, así como su representación y cómo se pueden utilizar en programas reales. Además, familiariza al usuario con los conceptos básicos de programación y el lenguaje Python.
