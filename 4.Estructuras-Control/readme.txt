...
El código proporcionado muestra ejemplos de estas estructuras utilizando variables y condiciones simples. Por ejemplo, se evalúa si un número es positivo, par o impar utilizando las estructuras condicionales `if`, `if-else`, e `if-elif-else` respectivamente. Además, se incluyen ejemplos de bucles `for` y `while` para mostrar cómo se pueden repetir acciones.
